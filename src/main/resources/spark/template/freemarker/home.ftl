...
<head>
    ...
    <!-- Toastr style -->
    <link href="/stylesheets/plugins/toastr/toastr.min.css" rel="stylesheet">
    ...
    <link href="/stylesheets/frontpage.css" rel="stylesheet">
...
<body>
    <div id="wrapper">
        ...
        <div class="logo">
            <a href="/home.ftl">Duke <span class="smaller">EXCHANGE</span></a>
        </div>
        ...
        <div class="foobar float-e-margins text-center animated fadeInDown">
                ...
                <form method="post" action="/home.ftl">
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <button method = "post" class="space btn-lg search-buttons" action="/home.ftl" type="submit">
                ...
                <div class="misc" style=" border-left: none; margin-right: 80px">
                <a>Search History</a></div>
                <div class="misc"><a>About us</a></div> 
        </div>
                        ...
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-desc">
                                ...
                                <div class="m-t text-righ">
                                    ...
                                    <a href="#" class="btn btn-xs btn-outline btn-primary"><span>Get it now </span><i class="fa fa-long-arrow-right"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
